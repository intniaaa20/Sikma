...
<div
    ...
    <nav
        ...
        <div class="flex items-center gap-x-4">
            ...
            <div class="relative">
                <button
                    class="inline-flex items-center gap-x-1 rounded-lg bg-gray-100 px-3 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-200 dark:bg-white/5 dark:text-gray-200 dark:hover:bg-white/10">
                    Monthly
                    <x-filament::icon icon="heroicon-m-chevron-down" class="h-4 w-4 text-gray-500 dark:text-gray-400" />
                </button>
            </div>
        </div>
        ...
        <div @if (filament()->hasTenancy()) x-persist="topbar.end.tenant-{{ filament()->getTenant()?->getKey() }}"
            @else
                x-persist="topbar.end" @endif
