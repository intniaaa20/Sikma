...
@section('title', 'Admin - Semua Riwayat Pesanan')

@section('content')
    <h1 class="text-2xl font-bold mb-6">Semua Riwayat Pesanan</h1>
    @if ($orders->isEmpty())
            ...
            <table class="min-w-full divide-y divide-yellow-200">
                <thead class="bg-gradient-to-r from-yellow-200 to-yellow-400">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-bold text-yellow-800 uppercase tracking-wider">Customer
                        </th>
                ...
                <tbody class="bg-white divide-y divide-yellow-100">
                    @foreach ($orders as $order)
                        ...
                        <tr id="order-detail-{{ $order->id }}"
                            ...
                            <td colspan="6" class="bg-yellow-50 px-4 py-4">
